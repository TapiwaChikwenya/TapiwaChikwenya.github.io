/*1669265089,,JIT Construction: v1006637098,en_US*/
...
try {
    (window.FB && !window.FB.__buffer) || (function() {
        ...
        for (var i = 0; i < sandboxSafelist.length; i++) {
            ...
            with(this) {
                ...
                __d("sdk.Auth", ["Log", "UrlMap", "sdk.AuthState", "sdk.AuthStorageUtils", "sdk.AuthUtils", "sdk.Cookie", "sdk.Frictionless", "sdk.LoggingUtils", "sdk.Runtime", "sdk.Scribe", "sdk.SignedRequest", "sdk.URI", "sdk.ui"], (function(a, b, c, d, e, f, g) {
                    b("sdk.Frictionless");
                    var h = 5 * 1e3;
                ...
                __d("ChatPluginStyleUtils", ["LiveChatPluginConstants"], (function(a, b, c, d, e, f, g) {
                    ...
                    function C(a, b, c, d, e, f, g, h) {
                        ...
                        return Object.fromEntries(ES("Object", "entries", !1, g).sort())
                    }
                    ...
                    function K(a, b, c, d, e, f, g) {
                        d = g === "compact" ? s : r;
                        var j = "position: fixed; z-index: 2147483646; box-shadow: none; border-radius: 18px 0px 18px 18px; right: 0px; width: calc(80% - 40px); bottom: 24px;";
                        ...
                        j += b === "left" ? " left: calc(84px + 5%);" : " left: 5%;";
                        if (f && (e !== "none" && typeof c === "number")) {
                            ...
                            switch (b) {
                                case "right":
                                    j += " right: 20px; left: auto;";
                                    break;
                                case "left":
                                    j += " left: 20px; right: auto;";
                                    break
                            }
                        }
                        return j
                    ...
                    a = function(a) {
                        ...
                        e.render = function(a) {
                            ...
                            c("CORSRequest").execute(a, "get", this.params, function(a) {
                                ...
                                e = d("ChatPluginStyleUtils").getEntryPointStyle(a.alignment, a.bottom_spacing, a.side_spacing, !1, !0, a.entry_point_label, !0, b.$ChatDOMFacade8);
                ...
                __d("sdk.XFBML.MessengerCheckboxWrapper", ["CORSRequest", "UrlMap", "sdk.Observable", "sdk.XFBML.MessengerCheckbox"], (function(a, b, c, d, e, f, g) {
                    a = function(a, b, c, d) {
                        return new h(a, b, c, d)
                    };
                    var h = function(b) {
                        ...
                        e.process = function() {
                            ...
                            c("CORSRequest").execute(b, "get", {
                                ...
                                a.$MessengerCheckboxWrapper5.should_use_new_domain = b.should_use_new_domain, a.$MessengerCheckboxWrapper1 = new(c("sdk.XFBML.MessengerCheckbox"))(a.$MessengerCheckboxWrapper2, a.$MessengerCheckboxWrapper3, a.$MessengerCheckboxWrapper4, a.$MessengerCheckboxWrapper5), a.$MessengerCheckboxWrapper1.subscribe("render", function() {
                                    a.inform("render")
                ...
                __d("sdk.XFBML.MessengerMessageUsWrapper", ["CORSRequest", "UrlMap", "sdk.Observable", "sdk.XFBML.MessengerMessageUs"], (function(a, b, c, d, e, f, g) {
                    a = function(a, b, c, d) {
                        return new h(a, b, c, d)
                    };
                    var h = function(b) {
                        ...
                        e.process = function() {
                            ...
                            c("CORSRequest").execute(b, "get", {
                                ...
                                a.$MessengerMessageUsWrapper5.should_use_new_domain = b.should_use_new_domain, a.$MessengerMessageUsWrapper1 = new(c("sdk.XFBML.MessengerMessageUs"))(a.$MessengerMessageUsWrapper2, a.$MessengerMessageUsWrapper3, a.$MessengerMessageUsWrapper4, a.$MessengerMessageUsWrapper5), a.$MessengerMessageUsWrapper1.subscribe("render", function() {
                                    a.inform("render")
                ...
                __d("sdk.XFBML.SendToMessengerWrapper", ["CORSRequest", "UrlMap", "sdk.Observable", "sdk.XFBML.SendToMessenger"], (function(a, b, c, d, e, f, g) {
                    a = function(a, b, c, d) {
                        return new h(a, b, c, d)
                    };
                    var h = function(b) {
                        ...
                        e.process = function() {
                            ...
                            c("CORSRequest").execute(b, "get", {
                                ...
                                a.$SendToMessengerWrapper5.should_use_new_domain = b.should_use_new_domain, a.$SendToMessengerWrapper1 = new(c("sdk.XFBML.SendToMessenger"))(a.$SendToMessengerWrapper2, a.$SendToMessengerWrapper3, a.$SendToMessengerWrapper4, a.$SendToMessengerWrapper5), a.$SendToMessengerWrapper1.subscribe("render", function() {
                                    a.inform("render")
    ...
    i.src = 'https://www.facebook.com/platform/scribe_endpoint.php/?c=jssdk_error&m=' + encodeURIComponent('{"error":"LOAD", "extra": {"name":"' + e.name + '","line":"' + (e.lineNumber || e.line) + '","script":"' + (e.fileName || e.sourceURL || e.script || "sdk.js") + '","stack":"' + (e.stackTrace || e.stack) + '","revision":"1006637098","namespace":"FB","message":"' + e.message + '"}}');
